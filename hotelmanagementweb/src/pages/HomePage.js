...
const HomePage = () => {
    ...
    return (
        <>
            {/* Hero Section */}
            <section className="relative flex flex-col items-center justify-center text-center px-6 py-24 bg-gradient-to-r from-indigo-100 via-white to-cyan-100 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
                {user ? (
                    <>
